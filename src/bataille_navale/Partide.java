    ...
    public void initierPlateau(){
        ...
        if(type==3){
           ...
           while(caseDispo>0){
            ...
            plateau2=new Plateau(nom2,line,column); //Reste a faire tourner ca 2 foix pour les 2 joureurs
            //et générer une methode qui place random les elements des deux tabelaux.
